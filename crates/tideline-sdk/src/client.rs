...
impl HostClient {
    pub fn new(transport: Arc<StdioTransport>) -> Self {
        Self {
            transport: transport as Arc<dyn HostRpc>,
        }
    }
    ...
    pub async fn initialize(
        ...
        self.transport
            .call(
                "host/initialize",
                Some(
                    json!({"plugin_id": plugin_id, "version": version, "sdk_version": sdk_version}),
                ),
    ...
    pub async fn channel_list(&self) -> Result<Value, SdkTransportError> {
        self.transport
            .call("host/channel.list", Some(json!({})), Duration::from_secs(2))
            .await
    }
    ...
    pub async fn list_input_sources(&self) -> Result<Vec<AudioSource>, SdkTransportError> {
        let v = self
            .transport
            .call("host/sources.list", Some(json!({})), Duration::from_secs(5))
            .await?;
    ...
    pub async fn config_namespace_set(
        &self,
        namespace: &str,
        value: Value,
    ...
    pub async fn channel_attach_data(
        &self,
        channel_uuid: Uuid,
        data: Value,
    ) -> Result<(), SdkTransportError> {
    ...
    pub async fn settings_section_render(
        &self,
        section_id: &str,
        tree: Value,
    ) -> Result<(), SdkTransportError> {
        eprintln!(
            "SDK: settings_section_render called with section_id={}",
            section_id
        );
        self.transport
            .call(
    ...
    pub async fn unregister_settings_section(
        &self,
        surface_id: &str,
    ) -> Result<(), SdkTransportError> {
        self.transport
    ...
    pub async fn unregister_channel_overlay(
        &self,
        surface_id: &str,
    ) -> Result<(), SdkTransportError> {
        self.transport
    ...
    pub async fn unregister_iframe_surface(
        &self,
        surface_id: &str,
    ) -> Result<(), SdkTransportError> {
        self.transport
    ...
    pub async fn unregister_keybind_action(
        &self,
        action_id: &str,
    ) -> Result<(), SdkTransportError> {
        self.transport
    ...
    pub async fn unregister_input_overlay(
        &self,
        surface_id: &str,
    ) -> Result<(), SdkTransportError> {
        self.transport
